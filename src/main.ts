...
import { AreaObjMgr } from './SuperMarioGalaxy/AreaObj.js';

Scenes_SuperMarioGalaxy2.sceneGroup // Site pisses if this isn't used fsr real fix do not remove unless you figure it out
