...
const tuedayPathBase = 'TuesdayManifest'
...
class TeamFortress2SceneDesc implements SceneDesc {
    ...
    public async createScene(device: GfxDevice, context: SceneContext) {
        ...
        return createScene(context, loadContext, this.id, `${tuedayPathBase}/tf/maps/${this.id}.bsp`);
    }
}
...
class HalfLife2Ep2SceneDesc implements SceneDesc {
    ...
    public async createScene(device: GfxDevice, context: SceneContext) {
        ...
        const loadContext = new SourceLoadContext(filesystem);
        return createScene(context, loadContext, this.id, `${tuedayPathBase}/ep2/maps/${this.id}.bsp`);
    }
}
...
class HalfLife2SceneDesc implements SceneDesc {
    ...
    public async createScene(device: GfxDevice, context: SceneContext) {
        ...
        const loadContext = new SourceLoadContext(filesystem);
        return createScene(context, loadContext, this.id, `${tuedayPathBase}/hl2/maps/${this.id}.bsp`);
    }
}
...
class CounterStrikeGOSceneDesc implements SceneDesc {
    ...
    public async createScene(device: GfxDevice, context: SceneContext) {
        ...
        const loadContext = new SourceLoadContext(filesystem);
        return createScene(context, loadContext, this.id, `${tuedayPathBase}/csgo/maps/${this.id}.bsp`);
    }
}
...
class DayOfDefeatSceneDesc implements SceneDesc {
    ...
    public async createScene(device: GfxDevice, context: SceneContext) {
        ...
        const loadContext = new SourceLoadContext(filesystem);
        return createScene(context, loadContext, this.id, `${tuedayPathBase}/dod/maps/${this.id}.bsp`);
    }
}
